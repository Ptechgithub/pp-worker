...
GitHub Repository for [https://github.com/Ptechgithub/pp-worker](https://github.com/Ptechgithub/pp-worker)

[![Repository](https://img.shields.io/badge/View%20on-GitHub-blue.svg)](https://github.com/Ptechgithub/pp-worker)
...
2. Alternatively, you can click the button below to deploy directly.
   ...
   [![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/Ptechgithub/pp-worker)
...
2. multiple uuid environment variable
   ...
   when you set multiple uuid, you can wiill use `https://pp-worker.pages.dev/uuid1` to get the clash config and vless:// link.
